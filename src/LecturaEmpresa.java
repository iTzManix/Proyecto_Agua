...
public class LecturaEmpresa extends JFrame {
    ...
    private void createTable()
    {
        showTable.setModel(new DefaultTableModel(
                null,
                new String[]{"Nombre Empresa","Ubicacion","Numero de sucursales"}
        ));
    }


    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new LecturaEmpresa());
    }
}
